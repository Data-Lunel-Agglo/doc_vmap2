...
> ⚠️ Le module Cadastre est accessible aux personnes en ayant droit, c”est à dire à tout utilisateur pour lequel l”administrateur de l”application a attribué les droits nécessaires pour accéder au module.
